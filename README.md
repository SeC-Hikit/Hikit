...
S&C is a backend service that manages high level geo and meta data related to trails.
It is intended to provide trail support teams (like the CAI ones) with a rich API to update and maintain a trail library, while making this data available to users.
